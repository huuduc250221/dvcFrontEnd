    ...
    >
      ...
      <Form.Item name='params' >
        <Select placeholder='phòng ban'>
          <Select.Option value='todos'>phòng ban nào đó</Select.Option>
          <Select.Option value='posts'>phòng ban nào đó</Select.Option>
          <Select.Option value='albums'>phòng ban nào đó</Select.Option>
        </Select>
      </Form.Item>
      <Form.Item >
